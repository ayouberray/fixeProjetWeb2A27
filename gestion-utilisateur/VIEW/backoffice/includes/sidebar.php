...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        <a href="dashboard.php" class="sidebar-nav-item <?= $current_page == 'dashboard.php' ? 'active' : '' ?>">
            <i class="fas fa-tachometer-alt"></i> Dashboard
        </a>
        
        <?php if($isAdmin): ?>
            <a href="liste_utilisateurs.php" class="sidebar-nav-item <?= $current_page == 'liste_utilisateurs.php' ? 'active' : '' ?>">
                <i class="fas fa-users"></i> Utilisateurs
            </a>
        <?php endif; ?>
        
        <a href="emploi.php" class="sidebar-nav-item <?= $current_page == 'emploi.php' ? 'active' : '' ?>">
            <i class="fas fa-briefcase"></i> Emploi
        </a>
        
        <a href="concours.php" class="sidebar-nav-item <?= $current_page == 'concours.php' ? 'active' : '' ?>">
            <i class="fas fa-graduation-cap"></i> Concours
        </a>
        
        <a href="rendez_vous.php" class="sidebar-nav-item <?= $current_page == 'rendez_vous.php' ? 'active' : '' ?>">
            <i class="fas fa-calendar-check"></i> Rendez-vous
        </a>
        
        <a href="demandes.php" class="sidebar-nav-item <?= $current_page == 'demandes.php' ? 'active' : '' ?>">
            <i class="fas fa-file-alt"></i> Demandes
        </a>
        
        <a href="reclamations.php" class="sidebar-nav-item <?= $current_page == 'reclamations.php' ? 'active' : '' ?>">
