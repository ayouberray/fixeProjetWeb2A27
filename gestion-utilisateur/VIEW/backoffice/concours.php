...
<head>
    ...
    <title>innoGov | Gestion des concours</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-clos { background: #FFEBEE; color: #C62828; }
    ...
    <div class="main-content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <?php if($isAdmin): ?>
                    <a href="#" class="btn-add"><i class="fas fa-plus"></i> Ajouter un concours</a>
                <?php endif; ?>
            </div>
            <div style="overflow-x: auto;">
                <table>
                    <thead>
                        <tr><th>Concours</th><th>Organisme</th><th>Date ouverture</th><th>Date clôture</th><th>Postes</th><th>Inscrits</th><th>Statut</th><?php if($isAdmin): ?><th>Actions</th><?php endif; ?></tr>
                    </thead>
                    <tbody>
                        <tr><td><strong>Concours Administratif</strong></td><td>Fonction Publique</td><td>01/03/2026</td><td>30/04/2026</td><td>50</td><td>234</td><td><span class="badge badge-ouvert">Ouvert</span></td><?php if($isAdmin): ?><td><a href="#" class="btn-edit">Modifier</a><a href="#" class="btn-delete" onclick="return confirm('Supprimer ?')">Supprimer</a></td><?php endif; ?></tr>
                        <tr><td><strong>Concours Technicien</strong></td><td>Ministère Education</td><td>01/04/2026</td><td>15/05/2026</td><td>30</td><td>156</td><td><span class="badge badge-ouvert">Ouvert</span></td><?php if($isAdmin): ?><td><a href="#" class="btn-edit">Modifier</a><a href="#" class="btn-delete" onclick="return confirm('Supprimer ?')">Supprimer</a></td><?php endif; ?></tr>
                        <tr><td><strong>Concours Ingénieur</strong></td><td>Ministère Industrie</td><td>15/03/2026</td><td>01/06/2026</td><td>20</td><td>89</td><td><span class="badge badge-ouvert">Ouvert</span></td><?php if($isAdmin): ?><td><a href="#" class="btn-edit">Modifier</a><a href="#" class="btn-delete" onclick="return confirm('Supprimer ?')">Supprimer</a></td><?php endif; ?></tr>
                    </tbody>
                </table>
            </div>
        </div>
