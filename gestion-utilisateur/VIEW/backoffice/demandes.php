...
<head>
    ...
    <title>innoGov | Gestion des demandes</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-cours { background: #E3F2FD; color: #1976D2; }
    ...
    <div class="main-content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <?php if($isAdmin): ?>
                    <a href="#" class="btn-add"><i class="fas fa-plus"></i> Nouvelle demande</a>
                <?php endif; ?>
            </div>
            <div class="filter-bar">
                ...
                <select class="filter-select">
                    ...
                    <option>CIN</option>
                    <option>Extrait naissance</option>
            ...
            <div style="overflow-x: auto;">
                <table>
                    <thead>
                        <tr><th>N°</th><th>Citoyen</th><th>Type</th><th>Date</th><th>Statut</th><th>Actions</th></tr>
                    </thead>
                    <tbody>
                        <tr><td>#DEM-001</td><td>Ahmed Ben Ali</td><td>Passeport</td><td>10/04/2026</td><td><span class="badge badge-cours">En cours</span></td><td><a href="#" class="btn-edit">Traiter</a><a href="#" class="btn-view">Voir</a></td></tr>
                        <tr><td>#DEM-002</td><td>Sarra Mansouri</td><td>CIN</td><td>12/04/2026</td><td><span class="badge badge-approuve">Approuvé</span></td><td><a href="#" class="btn-view">Voir</a></td></tr>
                        <tr><td>#DEM-003</td><td>Mohamed Karray</td><td>Extrait naissance</td><td>14/04/2026</td><td><span class="badge badge-attente">En attente</span></td><td><a href="#" class="btn-edit">Traiter</a><a href="#" class="btn-view">Voir</a></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
