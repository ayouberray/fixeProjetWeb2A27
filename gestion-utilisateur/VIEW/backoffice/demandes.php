...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-cours { padding: 4px 10px; border-radius: 20px; font-size: 0.7rem; background: #E3F2FD; color: #1976D2; }
        .badge-approuve { padding: 4px 10px; border-radius: 20px; font-size: 0.7rem; background: #E8F5E9; color: #2E7D32; }
...
<div class="main-content">
    ...
    <div class="card">
        ...
        <div style="overflow-x: auto;">
            ...
            <tbody>
                <tr><td>#DEM-001</td><td>Ahmed Ben Ali</td><td>Passeport</td><td>10/04/2026</td><td><span class="badge-cours">En cours</span></td><td><a href="#" class="btn-edit">Traiter</a><a href="#" class="btn-view">Voir</a></td></tr>
                <tr><td>#DEM-002</td><td>Sarra Mansouri</td><td>CIN</td><td>12/04/2026</td><td><span class="badge-approuve">Approuvé</span></td><td><a href="#" class="btn-view">Voir</a></td></tr>
                <tr><td>#DEM-003</td><td>Mohamed Karray</td><td>Extrait naissance</td><td>14/04/2026</td><td><span class="badge-attente">En attente</span></td><td><a href="#" class="btn-edit">Traiter</a><a href="#" class="btn-view">Voir</a></td></tr>
            </tbody></table>
        </div>
    </div>
</div>
