...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'DM Sans', sans-serif; background: linear-gradient(135deg, #F5FCF9 0%, #EBF7F3 100%); min-height: 100vh; }
        
        .navbar { background: rgba(245, 252, 249, 0.85); backdrop-filter: blur(16px); position: fixed; top: 0; width: 100%; z-index: 1000; padding: 1rem 2rem; transition: all 0.3s; }
        ...
        .hero-overlay { position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(135deg, rgba(0,109,91,0.75) 0%, rgba(0,77,61,0.85) 100%); z-index: 1; }
        .hero-content { position: relative; z-index: 2; text-align: center; color: white; padding: 100px 20px; }
        ...
        .footer { background: linear-gradient(180deg, #0D3328, #0A281E); color: white; padding: 40px 2rem 20px; text-align: center; margin-top: 60px; }
...
<!-- HERO AVEC SLIDESHOW AUTOMATIQUE -->
<section class="hero">
    <div class="hero-content">
        <h1>Services Municipaux Digitalisés</h1>
        <p>Simplifiez vos démarches administratives dans une interface claire et moderne.</p>
