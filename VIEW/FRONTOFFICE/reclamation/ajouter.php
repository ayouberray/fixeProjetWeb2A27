...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-control.error { border-color: #DC2626; background-color: #FEE2E2; }
        ...
        .footer { background: linear-gradient(180deg, #0D3328, #0A281E); color: white; padding: 40px 2rem 20px; text-align: center; }
...
<nav class="navbar" id="navbar">
    <div class="navbar-container">
        ...
        <div class="nav-menu">
            ...
            <a href="ajouter.php" class="btn-primary">Déposer</a>
        </div>
    </div>
</nav>
