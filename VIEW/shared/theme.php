...
function theme_t($fr, $ar = null) {
    ...
    if ($isArabic && !preg_match('/\?{2,}/', $arabicText)) {
        return $arabicText;
    }
    ...
    <header class="topbar">
        <a class="brand" href="<?= htmlspecialchars(theme_url('VIEW/frontoffice/index.php'), ENT_QUOTES, 'UTF-8') ?>">
            ...
            <span class="brand__text">
                <strong><?= htmlspecialchars(theme_t('InnoGov', 'إنو جوف'), ENT_QUOTES, 'UTF-8') ?></strong>
    ...
    <?php if ($showFooter): ?>
        <footer class="site-footer">
            <div>
                ...
                <p><?= htmlspecialchars(theme_t('Telephone : +216 70 000 000', 'الهاتف: 000 000 70 216+'), ENT_QUOTES, 'UTF-8') ?></p>
            </div>
            <div>
