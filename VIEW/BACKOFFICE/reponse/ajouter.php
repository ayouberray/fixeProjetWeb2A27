...
<head>
    ...
    <title>InnoGov - Répondre à la réclamation</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card { background: rgba(255,255,255,0.95); backdrop-filter: blur(10px); border-radius: 20px; box-shadow: 0 24px 48px rgba(0,0,0,0.2); padding: 30px; max-width: 700px; width: 100%; margin: 0 auto; }
        .card-header { margin-bottom: 25px; }
        .card-header h2 { color: #006D5B; display: flex; align-items: center; gap: 10px; }
        .reclamation-info { background: #E6F4F0; padding: 15px; border-radius: 12px; margin-bottom: 25px; border-left: 4px solid #006D5B; }
        ...
        .error-message { color: #DC2626; font-size: 12px; margin-top: 5px; display: none; }
        .error-message.show { display: block; }
        .form-control.error { border-color: #EF4444; background-color: #FEE2E2; }
    ...
    <main class="admin-main">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-reply-all"></i> Répondre à la réclamation</h2>
            </div>
            ...
            <div class="reclamation-info">
                ...
                <p><strong>Citoyen :</strong> <?= htmlspecialchars($reclamation['citoyen']) ?></p>
            </div>
            ...
            <form method="POST" id="reponseForm" novalidate>
                <div class="form-group">
                    ...
                    <input type="text" name="nom_agent" id="nom_agent" class="form-control" placeholder="Votre nom complet">
                    <div class="error-message" id="nomAgentError">Le nom de l'agent est requis (min. 2 caractères)</div>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Service de l'agent</label>
                    <input type="text" name="service_agent" class="form-control" placeholder="Ex: Service Urbanisme">
                </div>
                
                <div class="form-group">
                    <label class="form-label">Type de réponse</label>
                    <select name="type_reponse" class="form-control" id="type_reponse">
                ...
                <div class="form-group">
                    ...
                    <textarea name="contenu" id="contenu" class="form-control" rows="6" placeholder="Votre réponse détaillée..."></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="decision" class="form-control" placeholder="Ex: Demande acceptée, Dossier transmis...">
                </div>
                
                <div>
                    <button type="submit" class="btn btn-primary" id="submitBtn"><i class="fas fa-paper-plane"></i> Envoyer la réponse</button>
                    <a href="../RECLAMATION/lister.php" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </main>
...
<script>
    ...
    // Menu toggle pour mobile (optionnel)
