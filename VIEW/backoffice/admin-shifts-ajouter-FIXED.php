...
require_once dirname(__FILE__) . "/../../CONTROLLER/ShiftController.php";
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($nom && $debut && $fin) {
        if($ctrl->ajouterShift($nom, $debut, $fin)) {
            ...
            $erreur = "Erreur lors de l'ajout du shift";
        }
    } else {
...
<div class="container">
    ...
    <form method="POST">
        <div class="form-group">
            ...
            <input type="text" name="nom_shift" placeholder="ex: Matin" required>
        </div>
        <div class="form-group">
