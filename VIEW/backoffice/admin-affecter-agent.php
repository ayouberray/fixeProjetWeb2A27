...
$agents = $db->prepare("SELECT id, nom, prenom FROM users WHERE role = 'agent'");
$agents->execute();
...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <p>Assigner un agent à un rendez-vous</p>
    </div>
</section>

<div class="container">
    <div class="card reveal">
        <div class="card-header"><h2 class="card-title">Affecter un agent au RDV #<?= $id_rdv ?></h2></div>
        <?php if($error): ?><div class="alert alert-danger"><?= $error ?></div><?php endif; ?>
        <?php if($success): ?><div class="alert alert-success"><?= $success ?></div><?php endif; ?>
        
        <form method="POST">
            <div class="form-group"><label class="form-label">Choisir un agent</label>
